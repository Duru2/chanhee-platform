  ...
  return (
    <section id="home" className="relative grid min-h-[94vh] overflow-hidden text-cream">
      ...
      <div className="relative z-10 self-end px-5 pb-24 pt-48 md:px-16 lg:max-w-3xl">
        <p className="section-label text-honey">A living digital home</p>
        ...
        <p className="mt-5 max-w-2xl text-lg leading-8 text-cream/90 md:text-xl">
          A cozy personal operating system where books, code, research, videos,
          faith, university life, and experiments become a growing public garden.
        </p>
        <div className="mt-7 flex flex-wrap gap-3">
          <a className="rounded-full bg-cream px-6 py-3 font-extrabold text-ink shadow-soft" href="#garden">
            Enter the study room
          </a>
          <a className="rounded-full border border-cream/45 bg-cream/10 px-6 py-3 font-extrabold text-cream" href="#hubs">
